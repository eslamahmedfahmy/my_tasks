...
import 'package:my_tasks/Screens/add_task_screen.dart';
import 'package:my_tasks/constances/colors.dart';
      ...
      print(myDate);
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                Image.asset('assets/images/—Pngtree—blue mobile phone layout free_4404519.png',
                  fit: BoxFit.cover,
